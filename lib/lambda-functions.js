...
class LambdaFunctionsClass extends Construct {
  constructor(scope, id) {
    ...
    // Here we have special functions that update the seats and the catalog tables in dynamodb
    ...
    // this.updateSeatsTable = this.#createFunctionsForIntegrationWithApiGWDynamoDB("update_seats", {read:false, write:true}, false)
  }
