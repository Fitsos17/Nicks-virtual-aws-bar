...
exports.handler = async (event) => {
  ...
  body = {
    ...
    orders:
      "When you are ready to order, go to the /orders route and enter the id of the drink you want to order. Our experienced barmen will make them as quickly and as soon as possible, so you'll have a great experience! 🍾",
  };
